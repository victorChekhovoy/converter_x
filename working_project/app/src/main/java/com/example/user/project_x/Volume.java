...
public class Volume extends AppCompatActivity {
    String[] data = {"milliliters","teaspoons", "tablespoons", "cups","liters","cubic meters"};
    ...
    void type_init(){
     ...
     types.put("teaspoons", 4.92892159);
     types.put("tablespoons", 14.7867648);
     types.put("cups", 250.0);
